...
for z in range(200):
	...
	versi = random.choice(["12","13","14","5_0_1","100","11","10","9","6_0_0","4_1_1"])
	...
	ua = f"Dalvik/2.1.0 (Linux; Android {str(versi)}; ASUS_I005DA Build/RKQ1.201022.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/381.0.0.29.105;]"
...
{color_text}│ {P2}Recode : MBLE-XD {color_text}│{color_text}│ {P2}Version : 2.0 {color_text}│{color_text}│ {P2}Fall Xavier Script {color_text}│
...
class Session:
	...
	def generate_ugent(self):
		...
		ugent = f"Mozilla/5.0 (Linux; Android {android_version}; {model_device} Build/{build_device}) [FBAN/MessengerLite;FBAV/{versi_chrome};FBPN/com.facebook.mlite;FBLC/{language};FBBV/{versi_app};FBCR/{simcard};FBMF/{merk_device};FBBD/{brand_device};FBDV/{model_device};FBSV/{android_version};FBCA/{cpu_device};FBDM/"+str(large_device)+";]"
		return ugent		
